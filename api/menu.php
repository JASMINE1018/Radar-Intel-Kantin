...
while ($row = $result->fetch_assoc()) {
    ...
    $items[] = [
       ...
       'foto' => $row['foto'] ? 'uploads/' . $row['foto'] : null, 
        'rating'    => $row['rating'],
        'total_votes' => isset($row['total_votes']) ? (int)$row['total_votes'] : 0,
...
echo json_encode([
    'stand' => [
        ...
        'foto' => $stand['foto'] ? 'uploads/' . $stand['foto'] : null,
        'rating'   => $stand['rating'],
        'total_votes' => isset($stand['total_votes']) ? (int)$stand['total_votes'] : 0,
    ],
